...
dfSIF['Duración'] = tryPass('Duración')

dfSIF['RN.mensual'] = tryPass('RN.mensual')
dfSIF['RN.semestral'] = tryPass('RN.semestral')
dfSIF['RN.Ytd'] = tryPass('RN.Ytd')
dfSIF['RN. 1Y'] = tryPass('RN. 1Y')
dfSIF['RN. 3Y'] = tryPass('RN. 3Y')
dfSIF['RN. 5Y'] = tryPass('RN. 5Y')

dfSIF['RB.mensual'] = tryPass('RB.mensual')
dfSIF['RB.semestral'] = tryPass('RB.semestral')
dfSIF['RB.Ytd'] = tryPass('RB.Ytd')
dfSIF['RB. 1Y'] = tryPass('RB. 1Y')
dfSIF['RB. 3Y'] = tryPass('RB. 3Y')
dfSIF['RB. 5Y'] = tryPass('RB. 5Y')
dfSIF['V.mensual'] = tryPass('V.mensual')
dfSIF['V.semestral'] = tryPass('V.semestral')
dfSIF['V.Ytd'] = tryPass('V.Ytd')
dfSIF['V. 1Y'] = tryPass('V. 1Y')
dfSIF['V. 3Y'] = tryPass('V. 3Y')
dfSIF['V. 5Y'] = tryPass('V. 5Y')
